...
class Code(CachingMixin, models.Model):
    ...
    description = models.TextField('Description', blank=True, help_text='How was the tool made?')
    summary = models.TextField(blank=True, help_text='Short summary of the tool')
