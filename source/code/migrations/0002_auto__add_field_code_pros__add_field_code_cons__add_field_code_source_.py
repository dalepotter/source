...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Code.pros'
        db.add_column('code_code', 'pros',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Code.cons'
        db.add_column('code_code', 'cons',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Code.source_code'
        db.add_column('code_code', 'source_code',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Code.documentation'
        db.add_column('code_code', 'documentation',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Code.pros'
        db.delete_column('code_code', 'pros')

        # Deleting field 'Code.cons'
        db.delete_column('code_code', 'cons')

        # Deleting field 'Code.source_code'
        db.delete_column('code_code', 'source_code')

        # Deleting field 'Code.documentation'
        db.delete_column('code_code', 'documentation')


    models = {
        'code.code': {
            'Meta': {'ordering': "('slug',)", 'object_name': 'Code'},
            'cons': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'documentation': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            ...
            'pros': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'source_code': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
